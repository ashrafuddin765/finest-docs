...
if ( $head_sec_bg ) {
    $fmc_dynamic_css .= '.section-bg,.section-bg.section-template-02,.section-bg.section-template-03 { background-color:' . esc_attr( $head_sec_bg ) . ' } ';
    $fmc_dynamic_css .= "\n";
}

if ( $section_bg_area ) {
    $fmc_dynamic_css .= '.fddocs-site-main , .fddocs-site-main.section-template-03 { background-color:' . esc_attr( $section_bg_area ) . ' } ';
    $fmc_dynamic_css .= "\n";
}
