...
if ( $cta_button_text_color ) {
    $fmc_dynamic_css .= '.fdocs-ctn .footer-button a { color:' . esc_attr( $cta_button_text_color ) . '} ';
    $fmc_dynamic_css .= "\n";
}

if ( $cta_button_font_size ) {
    $fmc_dynamic_css .= '.fdocs-ctn .footer-button a { font-size:' . esc_attr( $cta_button_font_size ) . 'px } ';
    $fmc_dynamic_css .= "\n";
}

if ( $cta_button_bg_color ) {
    $fmc_dynamic_css .= '.fdocs-ctn .footer-button a { background-color:' . esc_attr( $cta_button_bg_color ) . '} ';
    $fmc_dynamic_css .= "\n";
}

if ( $cta_button_border_radius ) {
    $fmc_dynamic_css .= '.fdocs-ctn .footer-button a { border-radius:' . esc_attr( $cta_button_border_radius ) . 'px } ';
    $fmc_dynamic_css .= "\n";
}
...
if ( $desc_font_size ) {
    $fmc_dynamic_css .= '.fddocs-single-content .fddocs-entry-content, .fddocs-single-content .fddocs-entry-content p {font-size: ' . esc_attr( $desc_font_size ) . 'px } ';
    $fmc_dynamic_css .= "\n";
}
if ( $postdesc_color ) {
    $fmc_dynamic_css .= '.fddocs-single-content .fddocs-entry-content, .fddocs-single-content .fddocs-entry-content p {color: ' . esc_attr( $postdesc_color ) . ' } ';
    $fmc_dynamic_css .= "\n";
}
if ( $entry_margin_bottom ) {
    $fmc_dynamic_css .= '.fddocs-single-content .fddocs-entry-content, .fddocs-single-content .fddocs-entry-content p {margin-bottom: ' . esc_attr( $entry_margin_bottom ) . 'px } ';
    $fmc_dynamic_css .= "\n";
}
...
if ( $table_area_backgound ) {
    $fmc_dynamic_css .= '.fddocs-single-wrap .fddocs-auto-in-content.fddocs-autoc-wrap, .fddocs-single-wrap .fddocs-autoc-wrap{ background-color:' . esc_attr( $table_area_backgound ) . ' } ';
    $fmc_dynamic_css .= "\n";
}
if ( $tablepadding ) {
    $fmc_dynamic_css .= '.fddocs-single-wrap .fddocs-auto-in-content.fddocs-autoc-wrap, .fddocs-single-wrap .fddocs-autoc-wrap {padding: ' . esc_attr( $tablepadding ) . ' } ';
    $fmc_dynamic_css .= "\n";
}
if ( $table_content_radius ) {
    $fmc_dynamic_css .= '.fddocs-single-wrap .fddocs-auto-in-content.fddocs-autoc-wrap, .fddocs-single-wrap .fddocs-autoc-wrap {border-radius: ' . esc_attr( $table_content_radius ) . 'px } ';
    $fmc_dynamic_css .= "\n";
}

if ( $toc_title_color ) {
    $fmc_dynamic_css .= '.fddocs-single-wrap .fddocs-auto-in-content.fddocs-autoc-wrap, .fddocs-single-wrap .fddocs-autoc-wrap .autoc h2 {color: ' . esc_attr( $toc_title_color ) . '} ';
    $fmc_dynamic_css .= "\n";
}

if ( $toc_title_font_size ) {
    $fmc_dynamic_css .= '.fddocs-single-wrap .fddocs-auto-in-content.fddocs-autoc-wrap, .fddocs-single-wrap .fddocs-autoc-wrap .autoc h2 {font-size: ' . esc_attr( $toc_title_font_size ) . 'px } ';
    $fmc_dynamic_css .= "\n";
}

if ( $toc_title_bottom ) {
    $fmc_dynamic_css .= '.fddocs-single-wrap .fddocs-auto-in-content.fddocs-autoc-wrap, .fddocs-single-wrap .fddocs-autoc-wrap .autoc h2 {margin-bottom: ' . esc_attr( $toc_title_bottom ) . 'px } ';
    $fmc_dynamic_css .= "\n";
}

if ( $table_title_size ) {
    $fmc_dynamic_css .= '.fddocs-single-wrap .fddocs-auto-in-content.fddocs-autoc-wrap, .fddocs-single-wrap .fddocs-autoc-wrap .autoc ul li a {font-size: ' . esc_attr( $table_title_size ) . 'px } ';
    $fmc_dynamic_css .= "\n";
}

if ( $table_title_color ) {
    $fmc_dynamic_css .= '.fddocs-single-wrap .fddocs-auto-in-content.fddocs-autoc-wrap, .fddocs-single-wrap .fddocs-autoc-wrap .autoc ul li a {color: ' . esc_attr( $table_title_color ) . '} ';
    $fmc_dynamic_css .= "\n";
}
if ( $table_title_hover ) {
    $fmc_dynamic_css .= '.fddocs-single-wrap .fddocs-auto-in-content.fddocs-autoc-wrap, .fddocs-single-wrap .fddocs-autoc-wrap .autoc ul li a:hover {color: ' . esc_attr( $table_title_hover ) . '} ';
    $fmc_dynamic_css .= "\n";
}

if ( $table_title_gap ) {
    $fmc_dynamic_css .= '.fddocs-single-wrap .fddocs-auto-in-content.fddocs-autoc-wrap, .fddocs-single-wrap .fddocs-autoc-wrap .autoc ul li {padding-bottom: ' . esc_attr( $table_title_gap ) . 'px } ';
    $fmc_dynamic_css .= "\n";
}
