<div class="wrap" id="finestdocs-app">
    ...
    <h1><?php _e( 'Documentations', 'finestdocs' ); ?> <a class="page-title-action" href="#" v-on:click.prevent="addDoc"><?php _e( 'Add Doc', 'finestdocs' ); ?></a></h1>
    ...
    <ul class="docs not-loaded" v-sortable>
        <li class="single-doc" v-for="(doc, index) in docs" :data-id="doc.post.id">
                                ...
                                <ul class="articles" v-if="article.child.length">
                                    <li v-for="(art, index) in article.child">
                                        ...
                                        <span class="actions finestdocs-row-actions">
                                            ...
                                            <span class="finestdocs-btn-add"  v-on:click.prevent="addSection(doc)" title="<?php esc_attr_e( 'Add article', 'finestdocs' ); ?>"><span class="dashicons dashicons-plus"></span></span>
                                        </span>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="add-section">
                <a class="button button-primary" href="#" v-on:click.prevent="addSection(doc)"><?php _e( 'Add Section', 'finestdocs' ); ?></a>
            </div>
        </li>
    </ul>
