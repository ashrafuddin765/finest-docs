                    ...
                    <li v-for="(section, index) in doc.child" :data-id="section.post.id">
                        <span class="section-title" v-on:click="toggleCollapse">
                            <a v-if="section.post.caps.edit" target="_blank" :href="editurl + section.post.id">
                                ...
                                {{ section.post.title }}<span v-if="section.post.status != 'publish'"
                            ...
                            <li class="article" v-for="(article, index) in section.child" :data-id="article.post.id">
                                ...
                                <span>
                                    <a v-if="article.post.caps.edit" target="_blank" :href="editurl + article.post.id">
                                        ...
                                        {{ article.post.title }}<span v-if="article.post.status != 'publish'"
                                    ...
                                    <span class="actions finestdocs-row-actions">
                                        ...
                                        <ul class="actions-menu">
                                            <li>
                                                <span class="toggler"><svg width="12" height="4" viewBox="0 0 12 4"
