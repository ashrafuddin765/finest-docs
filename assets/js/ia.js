new Vue({
    ...
    mounted: function () {
        ...
        jQuery.post(
            fddocs_vars.ajaxurl, {
                ...
                current_page_id: fddocs_vars.pageID,
            },
            function (data) {
    ...
    methods: {
        ...
        hideArticle: function (el) {
            ...
            jQuery(el.path[0]).siblings('.fddocs-entry-content').html('');
        },
...
(function ($) {
    ...
    $('.fddoc-ia-toggler div').on('click', function () {
        $(this).removeClass('active').siblings().addClass('active').parent().siblings('.fddocs-ia-main').toggleClass('active');
    })
